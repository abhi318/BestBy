...
struct FoodData {
    ...
    static let food_data:[String:(Int,String)] =
        ...
        "tomatoes": (12, "Tomatoes can typically last up to 2 weeks stored in the fridge.Tomatoes that are going bad will begin to get soft and may leak liquid. If they have begun to mold they have gone bad and should be thrown out."),
