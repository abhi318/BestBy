...
class MainViewController: UITabBarController  {
    ...
    override func viewDidLoad() {
        ...
        self.tabBar.items?[2].image = UIImage(named: "items")?.withRenderingMode(.alwaysOriginal)
        self.tabBar.items?[2].selectedImage = UIImage(named: "itemsSelected")?.withRenderingMode(.alwaysOriginal)
